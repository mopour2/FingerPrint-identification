...
type
  TSearchfinger = class(TForm)
    ...
    procedure IDEEnter(Sender: TObject);
...
{$R *.DFM}
//***********************************************************************
procedure TSearchfinger.FormShow(Sender: TObject);
begin
...
//***********************************************************************
procedure TSearchfinger.DelFing(ch:string);
begin

  if MessageDlg('Deleted Finger Info',mtWarning, [mbYes, mbNo], 0) = 3 then
  begin
    if (length(DM.Empshomare_bazn.AsString)>1) and (length(DM.Empshomare_bazn.AsString)<=6) then
    if(Dm.Fingers.FindKey([DM.Empshomare_bazn.AsString,ch])=True) then
    begin
      Dm.Fingers.Delete;
    end
  end;
...
//***********************************************************************
procedure TSearchfinger.CompEnabel;
begin
...
//***********************************************************************
procedure TSearchfinger.CompDesable;
begin
...
//***********************************************************************
function TSearchfinger.AddFing(ch:string):integer;
var
  bl: TBlobField;
iCounter,iCounterInner:integer;
bMatchingOk:boolean;
begin
   if (length(DM.Empshomare_bazn.AsString)<2) or (length(DM.Empshomare_bazn.AsString) > 6) then
   ...
   if (conterfingreg=4) and  (length(DM.Empshomare_bazn.AsString)>1)  and (length(DM.Empshomare_bazn.AsString)<=6)and (FlagRegFeature=true)then
   begin
//*************************************
...
//    edit2.text:=inttostr(length(sFeature));
    if sFeature = '' then
      ...
      begin
        if BioFast1.oleobject.MinutiaeCount(sFeature) < 10 then
        begin
         FlagRegFeature:=false; //cancel register
        end
        else
...
//*************************************
   ...
   begin
    ...
    begin
      ...
      DM.FingersFingerPrint.BlobType := ftBlob;
      DM.FingersFingerPrint.value:=FeatureRegister;
      DM.FingersID.AsString := DM.Empshomare_bazn.AsString;
      DM.FingersFingerPrintFast.BlobType := ftBlob;
      DM.FingersFingerPrintFast.value:=FeatureRegisterFast;
...
//****************************************************************************
procedure TSearchfinger.CheckBox4Click(Sender: TObject);
begin
...
//****************************************************************************
procedure TSearchfinger.CheckBox1Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox2Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox3Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox5Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox6Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox7Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox8Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox9Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
procedure TSearchfinger.CheckBox10Click(Sender: TObject);
begin
if flagReg=false then
...
//****************************************************************************
Function TSearchfinger.StatusDescription(iStatus : Integer) :String;
begin
  Case iStatus of
...
End ;
//****************************************************************************
procedure TSearchfinger.CopyHWnd();
var
   winSize:lrect ;
   hwndSrc: Longint;
   hSrcDC:Longint;
...
End;
//****************************************************************************
procedure TSearchfinger.GetTwipsPerPixel();
var
   NumPix:Longint;
begin
   // Set a global variable with the Twips to Pixel ratio.
   Searchfinger.Scaleby(3,2);
   NumPix := Searchfinger.Height;
   Searchfinger.Scaleby (1,1);
//   TwipsPerPixel := FormAddFing.Height / NumPix;
End;

//*****************************************************

procedure TSearchfinger.PentacomBiometricFingerprint1Status(Sender: TObject;
  iStatus: Smallint);
begin
...
//*****************************************************
procedure TSearchfinger.fingtik();
var path:string;
begin
...
//Image100.Picture.LoadFromFile(path+'image\'+TableInfoId.asstring+'.jpg');
  ...
  begin
  DM.Fingers.Filter:='ID = '''+DM.Empshomare_bazn.AsString+'''';
   ...
   if (Dm.FingersFingerID.asstring='1')then
    begin
     CheckBox1.Checked:=True; label21.Visible:=True;
      path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_1_1'+'.bmp';
    ...
    begin
      CheckBox2.Checked:=True; label22.Visible:=True;
        path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_2_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
     CheckBox3.Checked:=True; label23.Visible:=True;
       path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_3_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
      CheckBox4.Checked:=True; label24.Visible:=True;
        path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_4_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
     CheckBox5.Checked:=True; label25.Visible:=True;
       path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_5_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
      ...
      path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_6_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
     ...
     path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_7_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
     CheckBox8.Checked:=True; label28.Visible:=True;
       path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_8_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
      CheckBox9.Checked:=True; label29.Visible:=True;
        path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_9_1'+'.bmp';
     if FileExists(path) then
    ...
    begin
      CheckBox10.Checked:=True; label30.Visible:=True;
        path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_10_1'+'.bmp';
     if FileExists(path) then
...
//****************************************************************************
procedure TSearchfinger.DBNavigator1Click(Sender: TObject;
  Button: TNavigateBtn);
begin
     fingtik();
     Img1.Visible:=false;
...
//*****************************************************
procedure TSearchfinger.BitBtn2Click(Sender: TObject);
var
 FlagFind:boolean;
// Str : TStringStream;
// W : WideString;
...
//***********************************************************************
procedure TSearchfinger.BitBtn1Click(Sender: TObject);
var
 FlagFind:boolean;
// Str : TStringStream;
// W : WideString;
...
procedure TSearchfinger.AccFC(NoFing:integer;conterfingreg:integer);
Var
 H,W : Integer;
...
begin
 ...
 begin
  ...
  for i:=0 to Searchfinger.ComponentCount-1 do
    if (Searchfinger.Components[i]).Name='Image'+inttostr(NoFing) then
    begin
      x :=(Searchfinger.Components[i] as TImage).Height;
      y :=(Searchfinger.Components[i] as TImage).Width;
      (Searchfinger.Components[i] as TImage).Height := H;
      (Searchfinger.Components[i] as TImage).Width := W;
      Crd := Rect(0, 0, Form1.Width,Form1.Height );
      (Searchfinger.Components[i] as TImage).Canvas.CopyRect(Crd,Form1.Canvas,Crd);
      (Searchfinger.Components[i] as TImage).Height := x;
      (Searchfinger.Components[i] as TImage).Width := y;

      path := UMain.Dir+'\imeg_fp\'+DM.Empshomare_bazn.AsString+'_'+inttostr(NoFing)+'_'+inttostr(conterfingreg)+'.bmp';
...
procedure TSearchfinger.IdEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
Var
  i,code : Integer;
  Sw : Boolean;
...
//****************************************************************************
procedure TSearchfinger.FormActivate(Sender: TObject);
begin
  FMain.Visible := False;
end;

procedure TSearchfinger.FormClose(Sender: TObject;
...
//****************************************************************************
procedure TSearchfinger.DBNavigator2Click(Sender: TObject;
  Button: TNavigateBtn);
begin
     Img1.Visible:=false;
     Img2.Visible:=false;
...
//****************************************************************************
procedure TSearchfinger.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if key=13 then
   begin
...
//****************************************************************************
procedure TSearchfinger.Edit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var SW:boolean;
begin
   if key=66 then
...
//****************************************************************************
procedure TSearchfinger.DataSourceEmpDataChange(Sender: TObject;
  Field: TField);
begin
     fingtik();
end;
//****************************************************************************
procedure TSearchfinger.Edit1Enter(Sender: TObject);
begin
//activatekeyboardlayout($00000429,0);
loadkeyboardlayout('00000401' ,klf_activate);
DM.Emp.IndexName:='IX_Employees_1';
end;
//****************************************************************************
procedure TSearchfinger.IDEEnter(Sender: TObject);
begin
loadkeyboardlayout('00000409' ,klf_activate);
DM.Emp.IndexName:='IX_Employees';
end;
//****************************************************************************
procedure TSearchfinger.Edit2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    DM.Emp.IndexName:='IX_Employees';
    DM.Emp.IndexName:='IX_Employees_1';
...
//****************************************************************************
procedure TSearchfinger.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
...
//****************************************************************************
procedure TSearchfinger.Edit2Enter(Sender: TObject);
begin
loadkeyboardlayout('00000401' ,klf_activate);
DM.Emp.IndexName:='IX_Employees_1';
end;
